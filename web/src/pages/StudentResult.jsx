...
function StudentResult() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-green-400 to-cyan-500 flex items-center justify-center p-4">
			<div className="bg-green-100 bg-opacity-20 backdrop-blur-lg rounded-2xl shadow-2xl p-8 text-center">
				...
				{loading ? (
					...
					<div className="text-gray-800 text-center space-y-2">
						...
						<ul className="list-inside pt-2 inline-block text-left">
							<li className = "text-green-700 font-bold mb-2">Correct Answers: {result.correctAnswers}</li>
							<li className = "text-red-700 font-bold mb-2">Incorrect Answers: {result.incorrectAnswers}</li>
							<li className = "text-blue-700 font-bold mb-2">Total Questions: {totalQuestions ?? result.total}</li>
						</ul>
					</div>
				) : (
